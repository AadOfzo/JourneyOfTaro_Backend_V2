...
public class SongCollectionInputDto {
    ...
    public SongCollectionInputDto(Long songCollectionId, Boolean isSampleDemo, Boolean isDemo, Boolean isSingle, Boolean isEp, Boolean isAlbum, String songCollectionName, Boolean songCollectionIsPrivate) {
